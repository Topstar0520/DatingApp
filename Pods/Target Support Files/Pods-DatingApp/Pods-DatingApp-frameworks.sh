...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JASidePanels/JASidePanels.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/instagram-ios-sdk/instagram_ios_sdk.framework"
